...
import edu.utk.cycleushare.cycleknoxville.MainInput;
import edu.utk.cycleushare.cycleknoxville.ActivityRecognitionIntentService;
import edu.utk.cycleushare.cycleknoxville.IRecordService;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ServiceConnection sc = new ServiceConnection() {
			...
			public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                Firebase tripsRef = new Firebase("https://cycleushare.firebaseio.com/trips-started/"+
                ...
                switch (rs.getState()) {
					case RecordingService.STATE_IDLE:
						...
						RecordingActivity.this.setTitle("I Bike KNX - Recording...");
						break;
					...
					case RecordingService.STATE_PAUSED:
						...
						RecordingActivity.this.setTitle("I Bike KNX - Paused...");
						break;
		...
		finishButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (trip.numpoints > 0) {
                    ...
                    Firebase tripsRef = new Firebase("https://cycleushare.firebaseio.com/trips-completed/"+
                            sdf.format(new Date(System.currentTimeMillis())));
                    SimpleLogin authClient = new SimpleLogin(tripsRef);
                    authClient.checkAuthStatus(new SimpleLoginAuthenticatedHandler() {
