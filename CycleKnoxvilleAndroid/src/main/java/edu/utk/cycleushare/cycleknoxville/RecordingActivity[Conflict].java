	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ServiceConnection sc = new ServiceConnection() {
			...
			public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                Firebase tripsRef = new Firebase("https://ICycleKNX.firebaseio.com/trips-started/"+
                ...
                switch (rs.getState()) {
					case RecordingService.STATE_IDLE:
						...
						RecordingActivity.this.setTitle("Cycle Knoxville - Recording...");
						break;
					...
					case RecordingService.STATE_PAUSED:
						...
						RecordingActivity.this.setTitle("Cycle Knoxville - Paused...");
						break;
		...
		finishButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (trip.numpoints > 0) {
                    ...
                    Firebase tripsRef = new Firebase("https://ICycleKNX.firebaseio.com/trips-completed/"+
                            sdf.format(new Date(System.currentTimeMillis())));
                    SimpleLogin authClient = new SimpleLogin(tripsRef);
                    authClient.checkAuthStatus(new SimpleLoginAuthenticatedHandler() {
