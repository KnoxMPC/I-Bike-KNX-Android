...
/*      Not available for Knoxville

       Firebase glassRef = new Firebase("https://publicdata-weather.firebaseio.com/Knoxville/hourly/summary");
...
*/
    ...
    private void buildAlertMessageNoGps() {
        ...
        builder.setMessage("Your phone's GPS is disabled. I Bike KNX needs GPS to determine your location.\n\nGo to System Settings now to enable GPS?")
               .setCancelable(false)
    ...
    private void showWelcomeDialog() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Please enter your personal details so we can learn a bit about you.\n\nThen, try to use I Bike KNX every time you ride. Your trip routes will be sent to regional transportation planners to improve biking in the Knoxville area!\n\nThanks,\nThe I Bike KNX team")
               .setCancelable(false).setTitle("Welcome to I Bike KNX!")
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_CONTACT_US:
        	Intent myIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                    "mailto","cherry@utk.edu", null));

            myIntent.putExtra(Intent.EXTRA_SUBJECT, "I Bike KNX Android App");
