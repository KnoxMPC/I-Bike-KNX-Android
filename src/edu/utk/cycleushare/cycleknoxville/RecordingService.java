...
public class RecordingService extends Service implements LocationListener {
	...
	public class MyServiceBinder extends Binder implements edu.utk.cycleushare.cycleknoxville.IRecordService {
		public int getState() {
			return state;
		}
		...
		public void setListener(edu.utk.cycleushare.cycleknoxville.FragmentMainInput mia) {
	...
	public void registerUpdates(edu.utk.cycleushare.cycleknoxville.FragmentMainInput r) {
	...
	public void remindUser() {
		...
		CharSequence contentTitle = "I BIKE KNX - Recording";
		CharSequence contentText = "Tap to see your ongoing trip";
		Intent notificationIntent = new Intent(context, edu.utk.cycleushare.cycleknoxville.FragmentMainInput.class);
