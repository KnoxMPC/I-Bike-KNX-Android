...
public class DbAdapter {
	...
	public long createTrip(String purp, double starttime, String fancystart,
		...
		initialValues.put(K_TRIP_STATUS, edu.utk.cycleushare.cycleknoxville.TripData.STATUS_INCOMPLETE);
	...
	public Cursor fetchUnsentTrips() {
		Cursor c = mDb.query(DATA_TABLE_TRIPS, new String[] { K_TRIP_ROWID },
				K_TRIP_STATUS + "=" + edu.utk.cycleushare.cycleknoxville.TripData.STATUS_COMPLETE, null, null,
				null, null);
		if (c != null && c.getCount() > 0) {
			c.moveToFirst();
		}
	...
	public int cleanTripsCoordsTables() {
		...
		Cursor c = mDb.query(DATA_TABLE_TRIPS, new String[] { K_TRIP_ROWID,
				...
				+ edu.utk.cycleushare.cycleknoxville.TripData.STATUS_INCOMPLETE, null, null, null, null);
		...
		if (badTrips > 0) {
			mDb.delete(DATA_TABLE_TRIPS, K_TRIP_STATUS + "="
					+ edu.utk.cycleushare.cycleknoxville.TripData.STATUS_INCOMPLETE, null);
		}
		return badTrips;
	}
	...
	public long createNote(int noteType, double noterecorded,
		...
		initialValues.put(K_NOTE_STATUS, edu.utk.cycleushare.cycleknoxville.NoteData.STATUS_INCOMPLETE);
	...
	public Cursor fetchUnsentNotes() {
		Cursor c = mDb.query(DATA_TABLE_NOTES, new String[] { K_NOTE_ROWID },
				K_NOTE_STATUS + "=" + edu.utk.cycleushare.cycleknoxville.NoteData.STATUS_COMPLETE, null, null,
				null, null);
		if (c != null && c.getCount() > 0) {
			c.moveToFirst();
		}
	...
	public int cleanNoteTables() {
		...
		Cursor c = mDb.query(DATA_TABLE_NOTES, new String[] { K_NOTE_ROWID,
				...
				+ edu.utk.cycleushare.cycleknoxville.NoteData.STATUS_INCOMPLETE, null, null, null, null);
		...
		if (badNotes > 0) {
			mDb.delete(DATA_TABLE_NOTES, K_NOTE_STATUS + "="
					+ edu.utk.cycleushare.cycleknoxville.NoteData.STATUS_INCOMPLETE, null);
		}
		return badNotes;
	}
