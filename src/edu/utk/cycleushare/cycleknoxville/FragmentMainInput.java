...
public class FragmentMainInput extends Fragment implements LocationListener, OnMyLocationButtonClickListener, OnMapReadyCallback {

    public static final String ARG_SECTION_NUMBER = "section_number";

    Intent fi;
    edu.utk.cycleushare.cycleknoxville.TripData trip;
    edu.utk.cycleushare.cycleknoxville.NoteData note;
    ...
    public void onAttach(Context context) {
        ...
        //perm = new PermissionsHandler((Activity) context, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 120);
        //perm.requestPermissions();

        loc = new LocationApiHandler(context, this, REQUEST);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Intent rService = new Intent(getActivity(), edu.utk.cycleushare.cycleknoxville.RecordingService.class);
        ...
        noteThisButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    ...
                    fi = new Intent(getActivity(), edu.utk.cycleushare.cycleknoxville.NoteTypeActivity.class);
                    // update note entity
                    note = edu.utk.cycleushare.cycleknoxville.NoteData.createNote(getActivity());
                    ...
                    note.updateNoteStatus(edu.utk.cycleushare.cycleknoxville.NoteData.STATUS_INCOMPLETE);
    ...
    void startRecording() {
        ...
        ServiceConnection sc = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                switch (rs.getState()) {
                    case edu.utk.cycleushare.cycleknoxville.RecordingService.STATE_IDLE:
                        trip = edu.utk.cycleushare.cycleknoxville.TripData.createTrip(getActivity());
                        ...
                        break;
                    case edu.utk.cycleushare.cycleknoxville.RecordingService.STATE_RECORDING:
                        long id = rs.getCurrentTrip();
                        trip = edu.utk.cycleushare.cycleknoxville.TripData.fetchTrip(getActivity(), id);
                        isRecording = true;
                        startButton.setText("Save");
                        // startButton.setBackgroundColor(0xFF0000);
                        // MainInputActivity.this.pauseButton.setEnabled(true);
                    ...
                    // break;
                    case edu.utk.cycleushare.cycleknoxville.RecordingService.STATE_FULL:
    ...
    private void buildAlertMessageNoGps() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(
                getActivity());
        builder.setMessage(
                "Your phone's GPS is disabled. I BIKE KNX needs GPS to determine your location.\n\nGo to System Settings now to enable GPS?")
                .setCancelable(false)
    ...
    public void onResume() {
        ...
        if (map != null) {
            ...
            if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                //perm.requestPermissions();
                ActivityCompat.requestPermissions(getActivity(), new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 6523);
            } else {
                map.setMyLocationEnabled(true);
            }
...
*/	}
	...
	private void setUpMapIfNeeded() {
		...
		if (map == null) {
            ...
            SupportMapFragment frag = (SupportMapFragment) getChildFragmentManager().findFragmentById(R.id.map);//(SupportMapFragment) getActivity().getSupportFragmentManager().findFragmentById(R.id.map);
	...
	private void setUpLocationClientIfNeeded() {
		if (loc == null) {
            loc = new LocationApiHandler(getActivity(), this, REQUEST);
