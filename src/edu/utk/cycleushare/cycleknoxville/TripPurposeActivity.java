...
public class TripPurposeActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// list.add(values[i]);
		// }
		edu.utk.cycleushare.cycleknoxville.TripPurposeAdapter adapter = new edu.utk.cycleushare.cycleknoxville.TripPurposeAdapter(this, values);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_cancel_trip_purpose:
			...
			Intent i = new Intent(TripPurposeActivity.this, edu.utk.cycleushare.cycleknoxville.TabsConfig.class);
			i.putExtra("keepme", true);
			startActivity(i);
